...
public static class UsefulShit
{
    ...
    public static Vector3 RoundToPixel(this Vector3 v3)
    {
        return new Vector3(Mathf.Round(v3.x * 32f) / 32f, Mathf.Round(v3.y * 32f) / 32f, v3.z);
    }

    public static Vector2 RoundToPixel(this Vector2 v3)
    {
        return new Vector3(Mathf.Round(v3.x * 32f) / 32f, Mathf.Round(v3.y * 32f) / 32f);
    }
}
