...
//    public bool floats;
    ...
    protected void FixedUpdate()
    {
        ...
        var info = MoveResolver.Translate(new Vector2(hpos, vpos) - (Vector2)transform.position, radius);
        TouchingWall = info.wallTouch != 0;
        TouchingWallDirection = info.wallTouch;
        if(!info.moved)
        {
            HMomentum *= .8f;
        }
